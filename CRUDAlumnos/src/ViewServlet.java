	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (cks != null) {
			...
			if (!name.equals("") || name != null) {
		        ...
		        out.println("<br><a href='crearAlumno.html'>Agregar nuevo alumno</a>");
		        ...
		        out.print("<tr><th>Id</th><th>Número de control</th><th>Nombre</th><th>Curso</th><th>Semestre</th><th>Editar</th><th>Borrar</th></tr>");
		        if(list.isEmpty()) {
		        	out.print("<tr><th colspan=7>No se encontraron alumnos</th></tr>");
		        }else {
		        	for(Alumno a:list){  
		                out.print("<tr><td>"+a.getId()+"</td><td>"+a.getNumero()+"</td><td>"+a.getNombre()+"</td>"  
		                        +"<td>"+a.getCurso()+"</td><td>"+a.getSemestre()+"</td><td><a href='EditServlet?id="+a.getId()
		                        +"'>Editar</a></td><td><a href='DeleteServlet?id="+a.getId()+"'>Borrar</a></td></tr>");  
		               }
		        }          
		        out.print("</table>");  
			}
